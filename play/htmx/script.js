                ...
                (function (e, t) {
                    ...
                    return (function () {
                        ...
                        function Ce(e, t, r) {
                            ...
                            oe(
                                f(t, '[hx-swap-oob], [data-hx-swap-oob]'),
                                function (e) {
                        ...
                        function Re(e) {
                            oe(
                                f(e, '[hx-preserve], [data-hx-preserve]'),
                                function (e) {
                                    var t = te(e, 'id');
                        ...
                        function Kt(e, t, r, n) {
                            ...
                            e = B(e);
                            var i =
                                E(localStorage.getItem('htmx-history-cache')) ||
                                [];
                            for (var a = 0; a < i.length; a++) {
                                if (i[a].url === e) {
                                    i.splice(a, 1);
                        ...
                        function dr(e, t) {
                            ...
                            if (o.lastButtonClicked) {
                                s =
                                    s &&
                                    o.lastButtonClicked.formNoValidate !== true;
                            }
                            if (t !== 'get') {
                                hr(r, i, a, v(e, 'form'), s);
                            }
                                ...
                                if (i.length > 0) {
                                    for (var a = 0; a < i.length; a++) {
                                        ...
                                        if (o.indexOf('swap:') === 0) {
                                            ...
                                            o.indexOf('transition:') === 0
                                        ) {
                                            n['transition'] =
                                                o.substr(11) === 'true';
                                        } else if (
                                            o.indexOf('ignoreTitle:') === 0
                                        ) {
                                            n['ignoreTitle'] =
                                                o.substr(12) === 'true';
                                            ...
                                            b(
                                                'Unknown modifier in data-hx-swap: ' +
                                                    o
                                            );
                                        }
                                    }
                        ...
                        function Sr(e) {
                            return (
                                ne(e, 'hx-encoding') ===
                                    'multipart/form-data' ||
                                (h(e, 'form') &&
                                    ee(e, 'enctype') === 'multipart/form-data')
                            );
                        }
                        function Er(t, r, n) {
                            var i = null;
                        ...
                        function he(t, r, n, i, a, e) {
                            ...
                            var W = ae(n).boosted;
                            var q =
                                Q.config.methodsThatUseUrlParams.indexOf(t) >=
                                0;
                            var H = {
                                boosted: W,
                                useUrlParams: q,
                                ...
                                withCredentials:
                                    a.credentials ||
                                    O.credentials ||
                                    Q.config.withCredentials,
                                timeout:
                                    a.timeout || O.timeout || Q.config.timeout,
                                path: r,
                                triggeringEvent: i,
                            };
                        ...
                        function Mr(l, u) {
                            ...
                            if (O(f, /HX-Redirect:/i)) {
                                location.href =
                                    f.getResponseHeader('HX-Redirect');
                                n && location.reload();
                                return;
                            }
                            if (n) {
                            ...
                            if (o.shouldSwap) {
                                ...
                                var y = function () {
                                    try {
                                        ...
                                        c.classList.remove(
                                            Q.config.swappingClass
                                        );
                                        oe(n.elts, function (e) {
                                            if (e.classList) {
                                                e.classList.add(
                                                    Q.config.settlingClass
                                                );
                                            }
